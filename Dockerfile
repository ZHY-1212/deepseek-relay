...
RUN cd app/static/js && cat api.js router.js auth.js models.js dashboard.js chat.js history.js admin.js docs.js profile.js pricing.js app.js pet.js > bundle.js
RUN mkdir -p data
